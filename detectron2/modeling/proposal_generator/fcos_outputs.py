...
#from detectron2.utils.comm import reduce_sum, reduce_mean, compute_ious
from detectron2.layers import ml_nms, IOULoss
...
class FCOSOutputs(nn.Module):
    ...
    def predict_proposals(
        ...
        for b in boxlists:
            ...
            res = Instances(b.image_size)
            res.proposal_boxes = b.proposal_boxes
            res.objectness_logits = b.objectness_logits
            results.append(res)
    ...
    def forward_for_single_feature_map(
        ...
        for i in range(N):
            ...
            boxlist.proposal_boxes = Boxes(detections)
            boxlist.objectness_logits = torch.sqrt(per_box_cls)
            boxlist.gt_classes = per_class
    ...
    def select_over_all_levels(self, boxlists):
        ...
        for i in range(num_images):
            ...
            if number_of_detections > self.post_nms_topk > 0:
                cls_scores = result.objectness_logits
